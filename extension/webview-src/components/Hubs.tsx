...
export const AdrPanel: React.FC = () => {
  ...
  const decisionStatus = adrStatus(content);
  const reviewed = decisionStatus.accepted;
      ...
      <div style={{ border: `1px solid ${C.line}`, borderRadius: 12, background: C.card, padding: "16px 18px", minHeight: 200 }}>
        {selected ? <>
          <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", marginBottom: 10 }}>
            ...
            <span style={{ fontSize: 10.5, padding: "2px 7px", borderRadius: 999, border: `1px solid ${reviewed ? "#2f6b4a" : "#6b4a17"}`, color: reviewed ? "#7ed3a2" : "#f0b35b" }}>{decisionStatus.label}</span>
